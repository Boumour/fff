                ...
                <div class="x_panel">
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tr>
                        ...
                        @if($datas->image != '')
                          <td><a href="<?php echo env('STORAGE_URL')."team/".$datas->image; ?>" target="_blank"><img src="<?php echo env('STORAGE_URL')."team/".$datas->image; ?>" style="height: 60px; width: 60px;"></a></td>
                          @else
...
<div class="modal fade Edit" tabindex="-1" id="edit{{$newdata->id}}" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
      <div class="modal-content" style="width: 390px;">
      	<form class="form-horizontal form-label-left" action="{{ url('admin/our-team-submit') }}" method="POST" data-parsley-validate novalidate id="updateData" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
          </button>
          <h4 class="modal-title" id="myModalLabel2">Edit Team Member</h4>
        </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
                ...
                @if($newdata->image!='' || $newdata->image != NULL)
                   <img src="<?php echo env('STORAGE_URL')."team/".$newdata->image; ?>" height="60px" width="60px">
                @endif                    
            </div>
          </div>
        </div>
...
<div class="modal fade add" tabindex="-1" id="add" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
      <div class="modal-content" style="width: 390px;">
      	<form class="form-horizontal form-label-left" action="{{ url('admin/our-team-submit') }}" method="POST" data-parsley-validate novalidate id="addData" enctype="multipart/form-data">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
          </button>
          <h4 class="modal-title" id="myModalLabel2">Add Team Member</h4>
        </div>
        <div class="modal-body">
      		<input type="hidden" name="_token" value="{{ csrf_token() }}">
           ...
           <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Designation*</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
                <input type="text" required class="form-control" placeholder="User designation" id="designation" name="designation">                         
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Image*</label>
...
$(document).ready(function() {
  ...
  new PNotify({
          ...
          confirm: true
                ...
                $.ajax({
                type:"get",
                url:"{{url('admin/our-team-delete')}}?id="+id,
